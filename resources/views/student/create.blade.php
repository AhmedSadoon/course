            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" autofocus class="form-control" id="name" name="name"
                        value="{{ old('name') }}" placeholder="ادخل اسم الطالب">
                    @error('name')
                 ...
                 <div class="form-group">
                    ...
                    <input type="text"  class="form-control" id="phone" name="phone"
                        value="{{ old('phone') }}" placeholder="ادخل رقم الهاتف">
                    @error('phone')
                        <span style="color: red">{{ $message }}</span>
                    @enderror
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  class="form-control" id="address" name="address"
                        value="{{ old('address') }}" placeholder="ادخل العنوان">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  class="form-control" id="nationalID" name="nationalID"
                        value="{{ old('nationalID') }}" placeholder="ادخل رقم الهوية">
                    @error('nationalID')
                        <span style="color: red">{{ $message }}</span>
                    @enderror
                </div>
